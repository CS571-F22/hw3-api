...
export class BingoSquare {
    ...
    public static readonly ALL_DATA = [
        ...
        new BingoData(28, "theXpanther", "Out Of Memory Exception"),
        new BingoData(29, "theXpanther", "Find years-old undetected bug in prod"),
        new BingoData(30, "theXpanther", "Null Pointer Exception"),
        ...
        new BingoData(44, "likes_purple", "Integer Overflow Exception"),
        new BingoData(45, "likes_purple", "Variable _caseJokes"),
        ...
        new BingoData(65, "CrystalMoose", "log('made it this far')"),
